...
#define MAX_BLENDS 2000
	...
	Int			m_loadedTerrainTexturePage; ///< Cached terrain atlas page for the currently built batch.
	Int			m_loadedEdgeTexturePage;	///< Cached edge atlas page for the currently built batch.
	...
	// @feature Ronin 09/04/2026 Batch custom terrain edging by terrain/edge atlas page pairs for multi-page terrain atlases.
	void loadEdgingsInVertexAndIndexBuffers(WorldHeightMap* pMap, Int minX, Int maxX, Int minY, Int maxY,
		Int terrainTexturePage = -1, Int edgeTexturePage = -1);
